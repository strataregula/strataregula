...
class TestMergeCommand:
    ...
    def test_command_attributes(self):
        ...
        assert (
            ...
            == "Merge configurations with deep copy for same hierarchies"
        )
    ...
    async def test_execute_with_custom_strategy(self):
        ...
        result = await self.command.execute(
            base_data, **{"with": merge_data, "strategy": "append"}
        )
    ...
    async def test_execute_with_invalid_strategy(self):
        ...
        result = await self.command.execute(
            base_data, **{"with": merge_data, "strategy": "invalid_strategy"}
        )
    ...
    async def test_execute_with_file_path(self):
        ...
        try:
            ...
            result = await self.command.execute(base_data, with_=str(config_file))
    ...
    async def test_execute_with_yaml_string(self):
        ...
        result = await self.command.execute(base_data, with_=yaml_string)
    ...
    async def test_execute_with_invalid_yaml_string(self):
        ...
        with pytest.raises(ValueError, match="Invalid YAML string"):
            await self.command.execute(base_data, with_=invalid_yaml)
    ...
    async def test_execute_with_nonexistent_file(self):
        ...
        with pytest.raises(ValueError, match="Invalid YAML string"):
            await self.command.execute(base_data, with_=nonexistent_file)
...
class TestEnvironmentMergeCommand:
    ...
    async def test_execute_no_config_file_found(self):
        ...
        result = await self.command.execute(
            data, environment="development", config_dir=str(self.temp_path)
        )
    ...
    async def test_execute_with_different_file_patterns(self):
        ...
        result = await self.command.execute(
            data, environment="production", config_dir=str(self.temp_path)
        )
    ...
    async def test_execute_with_custom_strategy(self):
        ...
        result = await self.command.execute(
            data, environment="test", config_dir=str(self.temp_path), strategy="append"
        )
    ...
    async def test_execute_file_priority_order(self):
        ...
        result = await self.command.execute(
            data, environment="test", config_dir=str(self.temp_path)
        )
...
class TestConfigMergeCommand:
    ...
    async def test_execute_with_config_files(self):
        ...
        result = await self.command.execute(base_data, files=[str(file1), str(file2)])
    ...
    async def test_execute_with_nonexistent_files(self):
        ...
        result = await self.command.execute(
            base_data, files=["/nonexistent/file1.yaml", "/nonexistent/file2.yaml"]
        )
    ...
    async def test_execute_with_output_file(self):
        ...
        result = await self.command.execute(
            base_data, files=[str(config_file)], output=str(output_file), format="yaml"
        )
    ...
    async def test_execute_with_custom_strategy(self):
        ...
        result = await self.command.execute(
            base_data, files=[str(config_file)], strategy="append"
        )
...
class TestHierarchyInfoCommand:
    ...
    def test_command_attributes(self):
        ...
        assert (
            self.command.description
            == "Display hierarchy information and merge strategy"
        )
    ...
    async def test_execute_with_dict_data(self):
        ...
        data = {"level1": {"level2": {"key": "value"}}, "simple": "string"}
    ...
    def test_analyze_hierarchy_dict(self):
        ...
        data = {
            "level1": {"level2": "value", "level2b": {"level3": "deep"}},
            "simple": "value",
        }
        ...
        assert (
            hierarchy_info["total_keys"] > 3
        )  # At least level1, level2, level2b, level3, simple
    ...
    def test_analyze_hierarchy_max_depth(self):
        ...
        assert (
            hierarchy_info["structure"] == "max_depth_reached"
            or hierarchy_info["structure"] == "dict"
        )
    ...
    def test_get_merge_recommendation_smart_dict(self):
        ...
        recommendation = self.command._get_merge_recommendation(
            data, MergeStrategy.SMART
        )
...
class TestCommandIntegration:
    ...
    async def test_error_resilience(self):
        ...
        with pytest.raises(ValueError):
            await merge_cmd.execute({"base": "data"}, with_=str(corrupt_file))
