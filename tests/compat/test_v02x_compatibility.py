...
class TestEngineCompatibility:
    ...
    def test_engine_creation_shows_deprecation_warning(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            engine = Engine(config_path="test.yaml")
    ...
    def test_engine_with_template_dir_warns(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            assert len(w) >= 2
            assert any("template_dir parameter is deprecated" in str(warning.message) 
                      for warning in w)
    ...
    def test_engine_expand_pattern_deprecated(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            assert any("expand_pattern is deprecated" in str(warning.message) 
                      for warning in w)
    ...
    def test_engine_validate_deprecated(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            assert any("validate is deprecated" in str(warning.message) 
                      for warning in w)
    ...
    def test_engine_service_time_deprecated(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            assert any("service_time() is deprecated" in str(warning.message) 
                      for warning in w)
    ...
    def test_engine_get_metrics_deprecated(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            assert any("get_metrics is deprecated" in str(warning.message) 
                      for warning in w)
...
class TestConfigLoaderCompatibility:
    ...
    def test_config_loader_deprecated(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            warnings.simplefilter("always")
            loader = ConfigLoader(search_paths=["/configs"])
    ...
    def test_config_loader_load_deprecated(self, tmp_path):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            assert any("load is deprecated" in str(warning.message) 
                      for warning in w)
    ...
    def test_config_loader_merge_deprecated(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            assert any("merge is deprecated" in str(warning.message) 
                      for warning in w)
...
class TestTemplateEngineCompatibility:
    ...
    def test_template_render_deprecated(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            assert any("render is deprecated" in str(warning.message) 
                      for warning in w)
...
class TestLegacyFunctions:
    ...
    def test_cli_run_deprecated(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            assert any("cli_run is deprecated" in str(warning.message) 
                      for warning in w)
    ...
    def test_compile_config_deprecated(self, tmp_path):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            assert any("compile_config is deprecated" in str(warning.message) 
                      for warning in w)
            assert isinstance(result, dict)
    ...
    def test_load_yaml_deprecated(self, tmp_path):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            assert any("load_yaml is deprecated" in str(warning.message) 
                      for warning in w)
...
class TestMigrationPath:
    ...
    def test_new_api_does_not_warn(self, tmp_path):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            kernel = Kernel()
            result = kernel.compile(str(config_file))
...
class TestDeprecationMessages:
    ...
    def test_deprecation_suggests_alternative(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            compile_warnings = [
                w for w in w 
                if "compile is deprecated" in str(w.message)
            ]
    ...
    def test_deprecation_includes_removal_version(self):
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            assert any("will be removed in v1.0.0" in str(warning.message) 
                      for warning in w)
