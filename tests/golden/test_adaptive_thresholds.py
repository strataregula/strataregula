...
from strataregula.golden.history import HistoryManager, MetricsSnapshot, StatisticalAnalyzer
...
class TestStatisticalAnalyzer:
    ...
    def test_outlier_removal(self, tmp_path):
        ...
        values = [100, 101, 99, 102, 98, 1000, 103, 97, 0, 101]  # 1000 and 0 are outliers
...
class TestAdaptiveThresholdCalculator:
    ...
    def test_calculate_all_thresholds(self, tmp_path):
        ...
        metric_configs = {
            "latency_ms": {"threshold_type": "upper", "strategy": "confidence_interval"},
