...
from strataregula.core.config_compiler import CompilationConfig, ConfigCompiler
...
class TestPluginSystemIntegration:
    ...
    def setup_method(self):
        ...
        self.plugin_config = {
            "global": {"auto_discover": False, "lazy_loading": False, "max_errors": 3},
            "plugins": {
                "test-plugin": {
                    "enabled": True,
                    "priority": 10,
    ...
    def test_manual_plugin_registration(self):
        ...
        result = plugin_manager.expand_pattern(
            "test:sample.pattern", {"value": "test_value"}
        )
    ...
    def test_sample_plugins_functionality(self):
        ...
        expanded_key = next(iter(result.keys()))
    ...
    def test_plugin_configuration_loading(self):
        ...
        assert not global_config.auto_discover
        assert not global_config.lazy_loading
    ...
    def test_plugin_error_handling(self):
        ...
        result = plugin_manager.expand_pattern(
            "fail:test.pattern", {"value": "test_value"}
        )
    ...
    def test_hook_integration(self):
        ...
        compiler.expander.plugin_manager.hooks.register(
            "pre_expand", test_hook, name="test_hook"
        )
...
class TestPluginSystemEdgeCases:
    ...
    def test_malformed_plugin_configuration(self):
        ...
        global_config = config_manager.get_global_config()
        assert global_config.auto_discover  # Default value
