...
class WebSocketHandler:
    ...
    async def send_to_client(self, websocket: WebSocketServerProtocol, data: Any) -> None:
    ...
    async def broadcast(self, data: Any, exclude: Optional[Set[WebSocketServerProtocol]] = None) -> None:
